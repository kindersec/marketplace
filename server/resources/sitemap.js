...
const defaultPublicPaths = {
  ...
  returnRefund: { url: '/return-and-refund' },
  shippingDelivery: { url: '/shipping-and-delivery' },
  paymentBilling: { url: '/payment-and-billing' },
  prohibitedItems: { url: '/prohibited-items' },
  contact: { url: '/contact' },
  faq: { url: '/faq' },
  signup: { url: '/signup' },
  login: { url: '/login' },
