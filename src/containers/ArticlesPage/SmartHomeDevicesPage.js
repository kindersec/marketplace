            ...
            <article className={css.content}>
              <div className={css.articleHeader}>
                <div className={css.articleMeta}>
                  ...
                  <span className={css.author}>By Smart Home Expert</span>
                </div>
                <h1 className={css.pageTitle}>Top 7 Smart Home Devices You Should Consider in 2025</h1>
              ...
              <div className={css.navigation}>
                ...
                <ExternalLink className={css.externalLink} href="https://www.amazon.com/smart-home">
