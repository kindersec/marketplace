import logoImageDesktop from '../assets/domee_logo.png';
import logoImageMobile from '../assets/domee_logo.png';
...
export const marketplaceColor = '#1a2233'; // Deep blue for smart home marketplace
...
export const logoSettings = {
  height: 36, // PNG logo - using 36px height for better visibility
  format: 'image',
};
